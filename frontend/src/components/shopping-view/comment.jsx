...
const Comment = ({comment, onLike, onEdit, onDelete}) => {
    ...
    useEffect(() => {
        const getUser = async () => {
            try {
                const res = await fetch(`http://localhost:5000/api/admin/user/getuser/${comment.userId}`)
    ...
    const handleSave = async () => {
        try {
            const res = await fetch(`http://localhost:5000/api/admin/comment/editComment/${comment._id}`, {
                method: 'PUT',
                headers: {
                    ...
                    <>
                        ...
                        <div className='flex items-center pt-2 text-xs border-t dark:border-gray-700 max-w-fit gap-2'>
                            <button
                                ...
                                className={`text-gray-400 hover:text-blue-500 ${user && comment.likes.includes(user.id) && '!text-blue-500'}`}
                            >
